...
export const FormBuilderView: React.FC = () => {
  ...
  return (
    <div id="forms-view" className="flex flex-1 flex-col h-full overflow-y-auto bg-[#0d0d0d] text-zinc-100">
      {/* View Header */}
      <div className="border-b border-zinc-800/80 bg-zinc-950/40 px-6 py-6 backdrop-blur-md">
        <div className="mx-auto max-w-7xl flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={fetchForms}
              className="flex items-center gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900 px-3 py-2 text-xs font-medium text-zinc-300 transition-colors hover:bg-zinc-800 hover:text-white"
              title="Refresh forms"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-indigo-600/20 transition-all hover:bg-indigo-500 active:scale-95"
            >
        ...
        {bannerMessage && (
          <div
            className={`mt-4 mx-auto max-w-7xl flex items-center gap-2 rounded-lg p-3 text-xs font-medium border ${
        ...
        {/* Top Metric Cards */}
        <div className="mx-auto max-w-7xl mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
      ...
      <div className="border-b border-zinc-800/60 bg-zinc-950/20 px-6 py-3">
        <div className="mx-auto max-w-7xl flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          {/* Filter Tabs */}
          <div className="flex flex-wrap items-center gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900/60 p-1 text-xs">
            <button
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative flex-1 min-w-[200px]">
              ...
              <input
                ...
                className="w-full rounded-lg border border-zinc-800 bg-zinc-900/80 py-1.5 pl-8 pr-3 text-xs text-zinc-200 placeholder-zinc-500 focus:border-indigo-500 focus:outline-none"
              />
            </div>
      ...
      {/* Main Grid Area */}
      <div className="mx-auto max-w-7xl w-full flex-1 p-6">
